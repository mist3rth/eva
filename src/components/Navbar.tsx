  ...
  return (
    <>
      <motion.nav 
        ...
        className={cn(
          "fixed top-0 left-0 w-full z-50 h-[80px] flex items-center px-[5vw] transition-colors duration-500",
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="absolute inset-0 w-full h-full flex flex-col pt-32 pb-12 overflow-y-auto overflow-x-hidden scrollbar-hide overscroll-none"
            >
              {/* Close Button Inside - Strictly positioned to avoid layout shifts */}
              <button 
                onClick={() => setMobileMenuOpen(false)}
                className="absolute top-6 right-6 p-3 text-brand-text hover:text-brand-gold transition-colors duration-300 z-50"
