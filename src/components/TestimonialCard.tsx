    ...
    >
      ...
      <div className={`relative z-10 h-full ${isMobile ? 'p-6' : 'p-8'} flex flex-col justify-between`}>
        <div className={`bg-white/[0.03] backdrop-blur-xl border border-white/10 ${isMobile ? 'p-6' : 'p-8'} h-full flex flex-col`}>
          ...
          <div className={`pt-8 border-t border-white/10 mt-auto flex flex-col w-full`}>
            <span className="text-[8px] uppercase tracking-[0.2em] text-white/40 mb-1">PROJET LIVRÉ</span>
            <span className="text-[10px] uppercase tracking-[0.18em] font-medium text-brand-gold w-full leading-tight">{testimonial.project}</span>
          </div>
        </div>
      </div>
    </m.div>
